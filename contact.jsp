                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="header-top-left">
                                            <ul>
                                                ...
                                                <li><i class="fa fa-envelope" aria-hidden="true"></i><a href="#">Ranu@Restaurant.com</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="#">All Pages <i class="fa fa-angle-down"></i></a>
                                                            <ul>
                                                                ...
                                                                <li><a href="food-menu4.jsp">Food Menu 1</a></li>
                            ...
                            <div class="contact-us-left">   
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <h3>Address</h3>
                                        <p>No: 234, Colombo, Srilanka.</p> 
                                    </li>
                                    <li>
                                        <i class="fa fa-envelope-o" aria-hidden="true"></i>
                                        <h3>E-mail</h3>
                                        <p>Ranu@restaurantfamily.com</p>   
                                    </li>
                                    <li>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="footer-box">
                                <h3 class="title-bar-footer">Mr.Ranu</h3>
